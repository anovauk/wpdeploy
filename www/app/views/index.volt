...
<head>
    ...
    <!-- Bootstrap Tables -->
    <link href="{{ baseUrl }}bower_components/bootstrap-table/dist/bootstrap-table.min.css" rel="stylesheet">
    <!-- Toastr -->
	...
	<!-- Include Popper.js -->
    <script src="{{ baseUrl }}bower_components/popper.js/dist/umd/popper.min.js"></script>
    ...
    <script src="{{ baseUrl }}bower_components/bootstrap-table/dist/bootstrap-table.min.js"></script>
    <!-- https://select2.org/getting-started/installation -->
